...
AreciboAblak::AreciboAblak(int szelesseg, int magassag, std::string uzenet, QWidget *parent): QMainWindow(parent)
{
...
QPainter qpainter(this);
	...
	if(uzenet.at(i*szelesseg+j) == '1')
		qpainter.fillRect(j*cellaSzelesseg, i*cellaMagassag, cellaSzelesseg, cellaMagassag, Qt::black);
	else
